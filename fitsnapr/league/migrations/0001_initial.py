...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('schedule_day', models.CharField(choices=[('Monday', 'Monday'), ('Tuesday', 'Tuesday'), ('Wednesday', 'Wednesday'), ('Thursday', 'Thursday'), ('Friday', 'Fridayday'), ('Saturday', 'Saturday'), ('Sunday', 'Sunday')], default=1, max_length=30)),
                ('schedule_type', models.CharField(choices=[('Co-ed', 'Co-ed'), ("Men's", "Men's"), ("Women's", "Women's")], default=1, max_length=30)),
                ('compete_type', models.CharField(choices=[('Beginner', 'Beginner'), ('Intermediate', 'Intermediate'), ('Advanced', 'Advanced')], default=1, max_length=30)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('date_joing', models.DateField(auto_now_add=True)),
